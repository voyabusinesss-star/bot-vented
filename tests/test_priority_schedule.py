...
def test_yaml_priorities_loaded() -> None:
    ...
    assert cfg.priorities["high"].poll_interval_seconds == 8.0
    assert cfg.priorities["medium"].poll_interval_seconds == 15.0
    assert cfg.priorities["high"].max_discord_posts == 6
    assert cfg.priorities["medium"].max_discord_posts == 4
